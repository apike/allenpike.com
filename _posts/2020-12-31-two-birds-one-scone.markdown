...
For example you could say that something is “cool”, which means you think it’s good, and also that you are old. Or, you could say that thing slaps, which means you think it’s good, and also that you are *not* old. Or you don’t want to be seen as old. Or you are attempting to embarrass your kids.
...
In the case of cool, the word’s meaning has shifted, but it still works. Sometimes, words’ implications shift in ways that we don’t want. Or their implications already are something we don't want, and we just don't realize it yet.

## Meaning is in the ear of the recipient

While our language continually mints new words, our society also deprecates old ones. Sometimes they just fall out of fashion. I know my grandma calls a couch a “chesterfield”, but nobody in my generation would call one that and that’s the way it goes.

Other times, though, we retire a phrase because it has an in-built hurtful or discriminatory connotation, or has developed one over time. As our society has become more tolerant over time many overtly racist, sexist, and homophobic terms have fallen out of use in everyday speech.
...
Meanwhile, there are [many other phrases probably worth banishing](https://mashable.com/2015/06/04/ally-vocabulary-banned-words/), dozens of words we may not yet recognize as problems today, but that could – if we don’t work them out of our systems – make us that caustic grandparent at some future dinner table. So it’s a journey.

If you are interested in prioritizing “crazy” for a vocabulary eviction, I have a little tidbit for you. The word crazy is used really broadly today, to the point of being a cliché. Since crazy is usually used to describe something that is interesting, there are a lot of novel words you can use instead. Depending on what you’re trying to say, your kids might be acting feral, that proposed schedule might be nonsensical, and your uncle might have been trying to sell you on his latest absurd scheme. And overall, it’s probably worth focusing on avoiding labelling people or their actions as crazy, and worrying about how to describe the crazy day you had further down the road.

As a maximally privileged person – and as a parent, and a manager – I always want to be putting in effort, slowly over time, to work words and phrases out of my vocabulary that might be seen as hurtful. Even if there’s no consensus yet that they’re offensive. This is one case where I think the price of being an early adopter is worthwhile.

We can’t control how people interpret our words, but we can practice continual improvement of what words we choose.

——

*Addendum*

In my research for this post, I reviewed a lot of problematic phrases and proposed alternatives. (We have a lot of work to do, people.) One of the more surprising candidates for banishment was the term “Kill two birds with one stone”. Coincidentally, I’d recently started using an alternative for this in recent months after seeing it on Twitter and enjoying it. To wit:
...
However, in addition to the two birds with one scone, I also another of their suggestions: swapping “Beat a dead horse” with “Feed a fed horse”. It subs in seamlessly for the existing cliché, and it also replaces the quite unnecessary unpleasantness of bludgeoning a deceased equine. Everybody wins.