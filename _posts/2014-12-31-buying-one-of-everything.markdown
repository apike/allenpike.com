...
If you really do want to keep things dead simple, you can just do like I do and use [WealthSimple](https://www.wealthsimple.com/invite/PIJJKW), a low cost online stock brokerage that lets you buy ETFs for free, and some [Vanguard ETFs](https://www.vanguardcanada.ca/individual/etfs/etfs.htm) to build an almost absurdly simple low-cost investment account:

1. Go to [WealthSimple](https://www.wealthsimple.com/invite/PIJJKW) or a similar online brokerage, and open a TFSA.
