...
summary: Battling the global supply chain in 2022.
...
When our second kid [was born](https://allenpike.com/2020/explain-like-im-3) a couple years back, I started working on getting us a bigger car. Due to my requirements, this proved… challenging.
...
The hot ticket of 2022 is what you could call the mid-priced true EV. These are the long-awaited SUVs and crossovers that have been designed from the platform up to be EVs, priced at the entry level for this market – around around $45k CAD. All four of these models were released in the last year:
...
Early reviews indicate these will be pretty compelling options in the space. As you look into 2024 there are also some 7-seater family vehicles on their way, like the Hyundai Ioniq 7, the Kia EV9, and the VW ID.Buzz. 
...
All this hustle sounds like a lot of work for an uncertain payoff! If the idea of spending many months hunting rare EVs does not appeal, it’s probably worth considering complementary tactics.
...
With this in mind, you might expand your search to consider what gas vehicles have been adapted to offer an EV variant. In terms of family-sized fare, today’s most compelling options are from Korea:

- **Hyundai Kona EV**
- **Kia Niro EV**
- **Kia Soul EV**

America intends to join the chat shortly with EV versions of the **Chevy Blazer**, **Chevy Equinox**, and **Ford Explorer**, and other manufacturers have EV version of their existing models on the way as well. Time will tell how compelling those offerings are.
...
If PHEVs don’t appeal, another axis you may be able to compromise on is size. While electric SUVs and crossovers are just now showing up, there is more availability of smaller EVs, new and used. A **Chevy Bolt EUV** or **Nissan Leaf** might be enough for a family that packs lightly, for example.
...
This has led to record profits, and the continued ability of customers to order Teslas. Today the Model Y you can just put down a reservation for a Model Y, with an estimated delivery of Nov 2022 to Feb 2023. That is rather a long time, but compares favourably to competitors’ estimated delivery range of *Oh man yeah, definitely not this year, we’re not sure when we’ll be able to file the existing pre-pre-orders for 2023 models into the system, after which point we might open up pre-pre-orders for 2024, I dunno man it’s a madhouse out there*

So maybe consider a Model Y if can stomach paying $82k CAD, plus $10k of sales taxes. You read that right: for the entry price of a Model Y, you could buy a RAV4, a CR-V, *and* a Niro. Don’t forget to add “self driving”!
...
There are so few used family EVs on the market that when you do find one, it may be going for as much as 20% over sticker price. On one hand this is travesty, but on the other hand… I mean, you want an EV, they’re selling an EV. This is what you might be thought of as the “close your eyes and buy a PS5 on eBay” path to getting an EV.
...
As deeply unsatisfying as it is, the most rational tactic for many of us will just be to wait another year or three. Over the next couple years, there are going to be more and more EV models debuting, with more and more supply of each as global chip shortages are finally worked out, and the supply of used EVs will start to, you know, exist.
...
That may or not be consolation. I know the frustration of living in a world where there is a really great car that *exists*, but you just can’t get your hands on one. But it might just need some time.
